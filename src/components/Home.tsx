        ...
        >
          ...
          >
            <span className="flex items-center">
              <img src={GameImage} alt="Game" className="w-10 h-10 mr-4" /> {/* Заменил SVG на изображение */}
